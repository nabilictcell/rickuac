    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                Director Info Update
            </header>
            <div class="panel-body">
                <form action="{{ route('ict-director-update',['id'=>$director->id])}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data" autocomplete="off">
                    {{ csrf_field() }}
                          <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                            <label class="control-label col-md-2">Title</label>
                            <div class="col-md-10">
                                <input type="text" name="title" class="form-control" id="title" value="{{ $director->title }}"/>
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('detail') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea name="detail" class="form-control summernote">{!! $director->detail !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('image') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-3">
                                <span><img src="{{ asset($director->image) }}" alt="Not Found" width="50" height="40" ></span>
                        ...
                        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="name" class="form-control" id="name" value="{{ $director->name }}"/>
                                @if ($errors->has('name'))
                                <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('designation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="designation" class="form-control" id="designation" value="{{ $director->designation }}"/>
                        ...
                        <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <textarea name="address" class="form-control" cols="30" rows="10">{!! $director->address !!}</textarea>
