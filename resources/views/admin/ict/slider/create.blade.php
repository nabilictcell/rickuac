    ...
    <div class="col-md-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="{{ route('ict-slider-store')}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data" autocomplete="off">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-2">
                                <a href="{{ route('ict-slider-index') }}" class="btn btn-md btn-info">Go Back</a>
                            </div>
                            <div class="col-md-4">
