    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                Former Personnel Info Update
            </header>
            <div class="panel-body">
                <form action="{{ route('ict-former-personnel-update',['id'=>$former_personnel->id])}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data" autocomplete="off">
                    {{ csrf_field() }}
                          <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                            <label class="control-label col-md-2">Title</label>
                            <div class="col-md-10">
                                <input type="text" name="title" class="form-control" id="title" value="{{ $former_personnel->title }}"/>
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea name="address" class="form-control summernote">{!! $former_personnel->address !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('designation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="designation" class="form-control" id="from" value="{{ $former_personnel->designation }}"/>
                        ...
                        <div class="form-group {{ $errors->has('from') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="from" class="form-control default-date-picker" id="from" value="{{ $former_personnel->from }}"/>
                                @if ($errors->has('from'))
                                <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('to') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="to" class="form-control default-date-picker" id="to" value="{{ $former_personnel->to }}"/>
                                @if ($errors->has('to'))
                                <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('order_by_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="order_by_number" class="form-control" value="{{ $former_personnel->order_by_number }}"/>
                        ...
                        <div class="form-group {{ $errors->has('slug') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                       id="slug" name="slug" placeholder="Slug" value="{{ $former_personnel->slug }}">
                                @if ($errors->has('slug'))
                                  <span class="help-block">
