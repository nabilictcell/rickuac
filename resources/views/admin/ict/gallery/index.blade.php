      ...
      <section class="panel">
          <header class="panel-heading">
           ...
           <div class="btn-group pull-right">
	             <a href="{{ route('ict-gallery-create')}}" class="btn btn-md btn-success">Add New</a>
	       </div>
          </header>
            ...
            <div class="adv-table">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          <a href="{{ route('ict-gallery-edit',['id'=>$item->id]) }}" class="btn btn-md btn-success">Edit</a>
                          ||
                          <form id="delete-form-{{ $item->id }}" method="post" action="{{ route('ict-gallery-destroy',['id'=>$item->id]) }}" style="display: none">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                        </form>
