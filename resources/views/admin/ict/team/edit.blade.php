    ...
    <div class="col-md-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="{{ route('ict-team-update',['id'=>$team->id])}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data" autocomplete="off">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group {{ $errors->has('detail') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea name="detail" class="form-control summernote">{!! $team->detail !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('category') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <select name="category" class="form-control">
                                    ...
                                    <option value="Joint Director"  {{ ($team->category == 'Joint Director' ? "selected":"") }}>Joint Director</option>
                                    <option value="Officer" {{ ($team->category == 'Officer' ? "selected":"") }}>Officer</option>
                                    <option value="Staff" {{ ($team->category == 'Staff' ? "selected":"") }}>Staff</option>
                                </select>
                        ...
                        <div class="form-group {{ $errors->has('image') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-3">
                                <span><img src="{{ asset($team->image) }}" alt="Not Found" width="50" height="40" ></span>
                        ...
                        <div class="form-group {{ $errors->has('order_by_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="order_by_number" class="form-control" value="{{ $team->order_by_number }}"/>
                        ...
                        <div class="form-group {{ $errors->has('slug') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                       id="slug" name="slug" placeholder="Slug" value="{{ $team->slug }}">
                                @if ($errors->has('slug'))
                                  <span class="help-block">
