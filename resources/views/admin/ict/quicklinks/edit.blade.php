    ...
    <div class="col-md-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="{{ route('ict-quicklinks-update',['id'=>$quicklink->id])}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data" autocomplete="off">
                    {{ csrf_field() }}
                          <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                            <label class="control-label col-md-2">Title</label>
                            <div class="col-md-5">
                                <input type="text" name="title" class="form-control" id="title" value="{{ $quicklink->title }}"/>
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('link') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="link" class="form-control" id="link" value="{{ $quicklink->link }}"/>
                                @if ($errors->has('link'))
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            <div class="col-md-2">
                                <a href="{{route('ict-quicklinks-index')}}" class="btn btn-md btn-info">Go Back</a>
                            </div>
                            <div class="col-md-4">
