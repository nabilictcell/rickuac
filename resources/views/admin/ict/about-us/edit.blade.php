    ...
    <div class="col-md-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="{{ route('ict-about-us-update',['id'=>$about->id])}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data" autocomplete="off">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group {{ $errors->has('detail') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea name="detail" class="form-control summernote">{!! $about->detail !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('category') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <select name="category" class="form-control">
                                  ...
                                  <option value="Vision and Mission" {{ ($about->category == 'Vision and Mission' ? "selected":"") }}>Vision and Mission</option>
                                  <option value="Objectives" {{ ($about->category == 'Objectives' ? "selected":"") }}>Objectives</option>
                                  <option value="Organogram" {{ ($about->category == 'Organogram' ? "selected":"") }}>Organogram</option>
                                </select>
                        ...
                        <div class="form-group">
                            <div class="col-md-2">
                                <a href="{{ route('ict-about-us-index')}}" class="btn btn-md btn-info">Go Back</a>
                            </div>
                            <div class="col-md-4">
