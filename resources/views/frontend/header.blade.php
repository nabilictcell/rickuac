<div class="header-top bg-theme-color-2 sm-text-center p-0" style="background-color: #921A40 !important;">
        ...
        <div class="col-md-8">
            ...
            <ul class="list-inline pull-right">
              <li class="mb-0 pb-0">
                <div class="top-dropdown-outer pt-5 pb-10">
                  <a class="top-cart-link has-dropdown text-white text-hover-theme-colored"><i class="fa fa-book font-13"></i></a>
          ...
          <div class="widget no-border m-0 mr-15 pull-right flip sm-pull-none sm-text-center">
            <ul class="styled-icons icon-circled icon-sm pull-right flip sm-pull-none sm-text-center mt-sm-15">
              ...
              <li><a href="https://www.linkedin.com/school/khulna-university/"><i class="fa fa-linkedin text-white"></i></a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-5">
            <div class="widget no-border m-0" style="display: flex; align-items: center; padding: 10px 0;">
                <a href="{{ route('ict') }}" style="display: inline-block; margin-right: 12px; margin-left: 0; padding: 0; flex-shrink: 0;">
                    <img src="{{ asset('frontend/images/ku.png') }}" alt="Khulna University" style="height: 64px; width: auto; display: block;">
                </a>
                <div style="display: inline-block;">
                    <a href="{{ route('ict') }}" style="font-weight: bold; font-size: 20px; color: #e41a1a; display: block; line-height: 1.2; text-decoration: none;">𝐑𝐄𝐒𝐄𝐀𝐑𝐂𝐇 & 𝐈𝐍𝐍𝐎𝐕𝐀𝐓𝐈𝐎𝐍</a>
                    <h6 class="font-18" style="color: #f4a024; font-family: 'Times New Roman', Times, serif; margin: 3px 0 0 0; line-height: 1.2;">Khulna University</h6>
                </div>
            </div>
        </div>
            ...
            <div class="widget no-border pull-right sm-pull-none sm-text-center mt-10 mb-10 m-0">
              <ul class="list-inline">
                ...
                <li>
                  ...
                  <h5 class="font-13 text-black m-0"> ICT CELL, Shahid Taj Uddin Ahmad Administrative Building, (3rd Floor),Khulna University, Khulna-9208</h5>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div class="header-nav" style="background-color: #C75B7A !important;">
    <div class="header-nav-wrapper navbar-scrolltofixed bg-theme-colored border-bottom-theme-color-2-1px" style="background-color: #C75B7A !important;">
      <div class="container" style="background-color: #C75B7A !important;">
        <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive" style="background-color: #C75B7A !important;">
          <ul class="menuzord-menu">
            <li class="active"><a href="{{ route('ict') }}">Home</a></li>
            <li><a href="#">About Us</a>
              <ul class="dropdown">
                <li><a href="{{ route('get_all_about_us',['category'=>'vision-and-mission']) }}">Vision and Mission</a></li>
          ...
          <ul class="pull-right flip hidden-sm hidden-xs">
            <li>
              ...
              <a class="btn btn-colored btn-flat bg-theme-color-2 text-white font-14 bs-modal-ajax-load mt-0 p-25 pr-15 pl-15" data-toggle="modal" data-target="#BSParentModal" href="http://ku.ac.bd/" style="background-color: #f2184f !important;">Khulna University</a>
              <!-- Modal: Book Now End -->
            </li>
          </ul>
        </nav>
